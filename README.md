...
<!-- ANIMATED TRANSITION WAVE INTO LIGHT BLUE CONTAINER -->
<p align="center" style="margin-top: 0px; margin-bottom: 0px;">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0e75b6,50:38bdf8,100:e0f2fe&height=100&section=header" width="100%" />
</p>

<!-- FULL-WIDTH LIGHT BLUE CONTENT CONTAINER -->
<table width="100%" bgcolor="#e0f2fe" style="border-collapse: collapse; border: none; margin-top: 0px;">
<tr>
...
<div align="center" style="margin-top: 15px; margin-bottom: 15px;">
  <table style="border-collapse: collapse; border: none; background: #ffffff; border-radius: 8px; padding: 10px;">
    <tr align="center">
      <td style="padding: 8px;"><img src="https://skillicons.dev/icons?i=linux" width="40" alt="Linux"/><br/><sub style="font-size: 11px;"><b>Linux</b></sub></td>
      <td style="padding: 8px;"><img src="https://skillicons.dev/icons?i=ubuntu" width="40" alt="Ubuntu"/><br/><sub style="font-size: 11px;"><b>Ubuntu</b></sub></td>
      <td style="padding: 8px;"><img src="https://skillicons.dev/icons?i=redhat" width="40" alt="RHEL"/><br/><sub style="font-size: 11px;"><b>RHEL</b></sub></td>
      <td style="padding: 8px;"><img src="https://skillicons.dev/icons?i=aws" width="40" alt="AWS"/><br/><sub style="font-size: 11px;"><b>AWS</b></sub></td>
      <td style="padding: 8px;"><img src="https://skillicons.dev/icons?i=gcp" width="40" alt="GCP"/><br/><sub style="font-size: 11px;"><b>GCP</b></sub></td>
      <td style="padding: 8px;"><img src="https://skillicons.dev/icons?i=docker" width="40" alt="Docker"/><br/><sub style="font-size: 11px;"><b>Docker</b></sub></td>
      <td style="padding: 8px;"><img src="https://skillicons.dev/icons?i=ansible" width="40" alt="Ansible"/><br/><sub style="font-size: 11px;"><b>Ansible</b></sub></td>
      <td style="padding: 8px;"><img src="https://skillicons.dev/icons?i=bash" width="40" alt="Bash"/><br/><sub style="font-size: 11px;"><b>Bash</b></sub></td>
      <td style="padding: 8px;"><img src="https://skillicons.dev/icons?i=git" width="40" alt="Git"/><br/><sub style="font-size: 11px;"><b>Git</b></sub></td>
      <td style="padding: 8px;"><img src="https://skillicons.dev/icons?i=github" width="40" alt="GitHub"/><br/><sub style="font-size: 11px;"><b>GitHub</b></sub></td>
      <td style="padding: 8px;"><img src="https://skillicons.dev/icons?i=nginx" width="40" alt="Nginx"/><br/><sub style="font-size: 11px;"><b>Nginx</b></sub></td>
    </tr>
  </table>
</div>
...
<div style="background: #ffffff; padding: 15px; border-radius: 8px; margin-bottom: 15px;">
  <h2 style="margin-top: 0; margin-bottom: 8px; color: #0e75b6;">👨‍💻 About Me</h2>
  ...
  <h3 style="margin-top: 10px; margin-bottom: 6px; color: #0e75b6;">🧩 Core Expertise</h3>
  <p style="margin: 0;">
...
<p align="center" style="margin-top: 15px; margin-bottom: 0;">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0e75b6,50:38bdf8,100:0e75b6&height=70&section=header&text=📈%20Impact%20%26%20Delivery%20Metrics&fontSize=18&fontColor=ffffff&fontAlignY=36&animation=fadeIn" width="100%" />
</p>

<div align="center" style="background: #ffffff; padding: 15px; border-radius: 0 0 8px 8px; margin-bottom: 15px;">
  <table width="100%">
    <tr align="center">
...
<!-- CURRENT FOCUS -->
<p align="center" style="margin-top: 15px; margin-bottom: 0;">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0e75b6,50:38bdf8,100:0e75b6&height=70&section=header&text=🚀%20Current%20Focus%20%26%20Learning&fontSize=18&fontColor=ffffff&fontAlignY=36&animation=fadeIn" width="100%" />
</p>
...
<!-- TECHNICAL SKILLS -->
<p align="center" style="margin-top: 15px; margin-bottom: 0;">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0e75b6,50:38bdf8,100:0e75b6&height=70&section=header&text=⚙️%20Technical%20Skills&fontSize=18&fontColor=ffffff&fontAlignY=36&animation=fadeIn" width="100%" />
</p>
...
<p align="center" style="margin-top: 15px; margin-bottom: 0;">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0e75b6,50:38bdf8,100:0e75b6&height=70&section=header&text=📌%20Featured%20Repositories&fontSize=18&fontColor=ffffff&fontAlignY=36&animation=fadeIn" width="100%" />
</p>

<div style="background: #ffffff; padding: 15px; border-radius: 0 0 8px 8px; margin-bottom: 15px;">
  <table width="100%">
    <tr>
      <td width="50%" valign="top">
        <h3 style="margin-top: 0; color: #0e75b6;">🐧 Linux & Automation</h3>
        <ul>
      ...
      <td width="50%" valign="top">
        <h3 style="margin-top: 0; color: #0e75b6;">🌐 Web Stack & Cloud Ops</h3>
        <ul>
...
<div style="background: #ffffff; padding: 15px; border-radius: 8px; margin-bottom: 15px;">
  <table width="100%">
    <tr>
      ...
      <td width="50%" valign="top">
        <h3 style="margin-top: 0; color: #0e75b6;">💼 Key Enterprise Projects</h3>
        <ul>
...
<!-- ANALYTICS -->
<p align="center" style="margin-top: 15px; margin-bottom: 0;">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0e75b6,50:38bdf8,100:0e75b6&height=70&section=header&text=📊%20GitHub%20Analytics&fontSize=18&fontColor=ffffff&fontAlignY=36&animation=fadeIn" width="100%" />
</p>
...
<p align="center" style="margin-top: 15px; margin-bottom: 0;">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:e0f2fe,50:38bdf8,100:0e75b6&height=80&section=footer" width="100%"/>
</p>

<p align="center" style="margin-top: 5px;"><b>⭐ Thanks for visiting my profile! Building reliable Linux, Cloud, and Automation solutions every day. ⭐</b></p>
